...
namespace trianglelib{
	...
	template<typename Scalar>
    void triangulatePolygon( std::vector< std::vector< Scalar > > & points, std::vector< std::vector< Scalar > > & holes, BasicMesh<Scalar>& mesh, char * tri_switches = nullptr)
	{
